...
*   *Example:* 저는 학교에 가요 (I go to school).
...
*   *Example:* 어제 피자를 먹었어요 (I ate pizza yesterday).
...
*   *Example:* 지금 공부하고 있어요. (I am studying now.)
...
*   *Example:* 갈 수 있어요 (I can go), 먹을 수 없어요 (I cannot eat).
...
*   *Example:* 먹어 보세요. (Try eating it.)
*   *Example:* 가 봤어요. (I have been there.)

### 68. Nominalization: Turning Verb into Noun (V + -기)
Used to turn a verb into a noun. Common for titles, skills, or hobbies.
*   *Example:* 책 읽기 (Reading books).
*   *Example:* 김치 만들기 (Making Kimchi).
