...
2. **Prompt:** When (it is) hot, I drink cold water.
   - **User:** 날시가 더울 때는 추은 물을 마셔요 -> **날씨가... 차가운 물을** (Spelling)
3. **Prompt:** I can't exercise today.
   - **User:** 언을 운동할 수 없어요 -> **오늘** (Spelling)
4. **Prompt:** On weekends, I watch movies or animations.
   - **User:** 주마레 영화나 애니마이션을 봐요 -> **주말에 영화를 보거나...** (Verb coordination preferred)
5. **Prompt:** The newly opened clothing store is big.
...
2. **Prompt:** I read books or sleep.
   - **User:** 책을 읽거나 자요 (Perfect!)
3. **Prompt:** You can buy clothes at the shopping mall.
   - **User:** 쇼핑몰에서 옷을 살 수 있어요 (Perfect!)
4. **Prompt:** When I study Korean, it is fun.
   - **User:** 한국어를 공부할 때는 재미있어요 (Perfect!)
5. **Prompt:** There are many newly opened restaurants.
