# Korean Vocabulary Roots (Hanja) Cheatsheet

### Home & Living
*   **가 (家 - House/Family):** 가구 (Furniture), 가사 (Housework), 가족 (Family)
*   **실 (室 - Room):** 거실 (Living room), 침실 (Bedroom), 욕실 (Bathroom)
*   **주 (住 - To live / 廚 - Kitchen):** 주택 (Housing), 주반 (Kitchen)

### Human & Body
*   **두 (頭 - Head):** 두통 (Headache), 두뇌 (Brain)
*   **안 (眼 - Eye):** 안과 (Eye clinic), 안경 (Glasses)
*   **심 (心 - Heart/Mind):** 심장 (Heart), 관심 (Interest), 조심 (Caution)
*   **수 (手 - Hand):** 수술 (Surgery), 박수 (Applause)
*   **족 (足 - Foot):** 족발 (Pig's feet dish)

### Nature & Weather
*   **기 (氣 - Air/Energy):** 공기 (Air), 기온 (Temperature), 전기 (Electricity)
*   **풍 (風 - Wind):** 태풍 (Typhoon), 선풍기 (Electric fan)
*   **우 (雨 - Rain):** 우산 (Umbrella), 우비 (Raincoat)

### Places & Transportation
*   **장 (場 - Place / Open Space):** 수영장 (Pool), 극장 (Theater), 주차장 (Parking), 시장 (Market), 장소 (Location), 정류장 (Bus stop)
*   **소 (所 - Place / Office):** 주소 (Address), 사무소 (Office), 장소 (Location)
*   **통 (通 - Pass/Communicate):** 교통 (Traffic), 통화 (Phone call)
*   **도 (到 - Arrive):** 도착 (Arrival)
*   **정 (停 - Stop):** 정류장 (Bus stop), 정지 (Halt)
